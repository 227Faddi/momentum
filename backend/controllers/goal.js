...
export default {
  ...
  addGoal: asyncHandler(async (req, res) => {
    if (!req.body.title) {
      res
        .status(400)
        .json({ status: 'error', message: 'Please add a title field' });
  ...
  completeGoal: asyncHandler(async (req, res) => {
    ...
    res
      .status(200)
      .json({ status: 'success', message: 'Goal completed! Good Job' });
  }),
  ...
  deleteGoal: asyncHandler(async (req, res) => {
    ...
    res
      .status(200)
      .json({ status: 'success', message: 'Goal deleted successfully' });
  }),
};
